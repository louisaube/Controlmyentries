...
function getIcon(type: StatusMessageProps['type']) {
  switch (type) {
    case 'success':
      return (
...
export function StatusMessage({
  ...
  const displayMessage = message || error?.detail

  return (
    <div
      className={`flex gap-3 p-4 rounded-lg border ${styles.container}`}
